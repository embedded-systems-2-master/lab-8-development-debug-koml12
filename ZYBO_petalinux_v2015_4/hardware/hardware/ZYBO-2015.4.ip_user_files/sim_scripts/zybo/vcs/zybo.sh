...
reset_run()
{
  files_to_remove=(ucli.key zybo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc zybo_simv.daidir)
...
elaborate()
{
  opts="-load "/opt/pkg/Xilinx/Vivado/2015.4/lib/lnx64.o/libxil_vcs.so:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"

  vcs $opts xil_defaultlib.zybo xil_defaultlib.glbl -o zybo_simv
}
