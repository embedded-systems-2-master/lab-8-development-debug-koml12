...
#
# Generated by Vivado on Wed Jan 20 15:02:34 UTC 2016
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: zybo.sh [-help]
# usage: zybo.sh [-lib_map_path]
# usage: zybo.sh [-noclean_files]
# usage: zybo.sh [-reset_run]
#
...
# executing this script. Please type 'zybo.sh -help' for more information.
#
...
# Script info
echo -e "zybo.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: zybo.sh [-help]\n\
Usage: zybo.sh [-lib_map_path]\n\
Usage: zybo.sh [-reset_run]\n\
Usage: zybo.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./zybo.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./zybo.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  libs=(xil_defaultlib axi_lite_ipif_v3_0_3 lib_cdc_v1_0_2 interrupt_control_v3_1_3 axi_gpio_v2_0_9 proc_sys_reset_v5_0_8 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_7 fifo_generator_v13_0_1 axi_data_fifo_v2_1_6 axi_crossbar_v2_1_8 axi_protocol_converter_v2_1_7)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/zybo/ip/zybo_processing_system7_0_0/sim/zybo_processing_system7_0_0.v" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/zybo/ip/zybo_axi_gpio_0_0/sim/zybo_axi_gpio_0_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/zybo/ip/zybo_rst_processing_system7_0_100M_0/sim/zybo_rst_processing_system7_0_100M_0.vhd" \
    "$ref_dir/../../../bd/zybo/ip/zybo_axi_gpio_0_1/sim/zybo_axi_gpio_0_1.vhd" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/zybo/ip/zybo_xbar_0/sim/zybo_xbar_0.v" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/zybo/ip/zybo_axi_gpio_0_2/sim/zybo_axi_gpio_0_2.vhd" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/zybo/ip/zybo_auto_pc_0/sim/zybo_auto_pc_0.v" \
    "$ref_dir/../../../bd/zybo/hdl/zybo.v" \
...
elaborate()
{
  opts="-loadvpi "/opt/pkg/Xilinx/Vivado/2015.4/lib/lnx64.o/libxil_ncsim.so:xilinx_register_systf" -64bit -relax -access +rwc -messages -logfile elaborate.log -timescale 1ps/1ps"
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname xil_defaultlib -libname axi_lite_ipif_v3_0_3 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_3 -libname axi_gpio_v2_0_9 -libname proc_sys_reset_v5_0_8 -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_7 -libname fifo_generator_v13_0_1 -libname axi_data_fifo_v2_1_6 -libname axi_crossbar_v2_1_8 -libname axi_protocol_converter_v2_1_7"
  ncelab $opts xil_defaultlib.zybo xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.zybo -input simulate.do
}
# Script usage
usage()
{
